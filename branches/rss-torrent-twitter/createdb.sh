...
INSERT INTO "config" (prop, value, descr) VALUES("twitter_user", "foo", "Your twitter username.");
INSERT INTO "config" (prop, value, descr) VALUES("twitter_pass", "bar", "Your twitter password.");
